...
public class EmployeeDAO {
    ...
    private static final String SELECT_EMP_LAST_NAME = "select * from employees where last_name = ?";
    ...
    public Employee selectEmpLastName(String last_name) throws SQLException, ClassNotFoundException {
        Class.forName("org.sqlite.JDBC");
        Connection conn = DriverManager.getConnection(URL);
        PreparedStatement st = conn.prepareStatement(SELECT_EMP_LAST_NAME);
